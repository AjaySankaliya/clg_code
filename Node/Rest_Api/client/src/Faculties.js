...
function Faculties() {
    ...
    const updateFaculty = async () => {
        try {
            const response = await fetch(`http://localhost:5000/api/faculty/update/${editFaculty.factId}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
    ...
    const deleteFaculty = async (id) =>{
        try{
            console.log("Edit faculty before : ",id);
        ...
        <div className="container">
            ...
            <div className="row">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form>
                                    ...
                                    <div className="mb-2">
                                        <label className="form-label">Add experience : </label>
                ...
                {editFaculty  &&  (
                    ...
                    <div className="mb-2">
                        <label className="form-label">Edit experience : </label>
                    ...
                    <div className="col-md-4 p-3 mt-2" key={fact.factId}>
                        <Card style={{ width: '18rem' }}>
                            ...
                            <Card.Body>
                                ...
                                <Button variant="primary">{fact.experience}</Button>
                                <button className='btn btn-warning ms-3' onClick={() => handelEditDetails(fact)}>Edit</button>
                                <button className='btn btn-danger ms-3' onClick={() => deleteFaculty(fact._id)}>Delete</button>
                            </Card.Body>
                        </Card>
                    </div>
                ))}
